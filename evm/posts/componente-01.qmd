...
subtitle: "Escala espacial y temporal del estudio, objetivos, alcance, tiempo del estudio y forma de trabajo"
date: 2023-01-01
...
![Definición del marco general del estudio](../../img/definicion-marco-general-puntos.png){fig-alt="Definición del marco general del estudio" fig-align="center" width=80%}

## 1. Escala espacial y temporal
...
![Ejemplo de una misma parcela vista en el T1 (2005) y T2 (2015)](../../img/parcela-t1-t2.png){fig-alt="Ejemplo de una misma parcela vista en el T1 (2005) y T2 (2015)" fig-align="center" width=80%}
