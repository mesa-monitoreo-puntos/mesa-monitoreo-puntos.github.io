...
subtitle: "Componente 2 de la EVM"
image: ../../img/evm-componente-02.png
toc: true
---
...
Algunas consideraciones para la selección del diseño de la parcela se pueden ver en la presentación [Consideraciones sobre el tamaño de la parcela y el número de puntos por parcela (Randy Hamilton)](../../recursos/Consideraciones_interpretacion_malla_de_puntos_y_mapa_tipo_de_bosques.pdf). 

## Herramientas a utilizar
Esto se refiere al sistema computacional que se utilizará para la interpretación de las parcelas. En el marco del SIMOCUTE se han sugerido dos herramientas para realizar este trabajo: el [Collect Earth Desktop (CED)](https://openforis.org/tools/collect-earth/) y [Collect Earth Online (CEO)](https://www.collect.earth/). 
...
![](../../img/fuente-imagenes.jpg){.lightbox fig-alt="Fuente de las imágenes" fig-align="center"}